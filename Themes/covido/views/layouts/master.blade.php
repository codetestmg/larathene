...
<head>
    ...
    <!-- fevicon -->
    <link rel="icon" href="{{themes('images/fevicon.png')}}" type="image/gif" />
...
<!-- loader  -->
<div class="loader_bg">
    <div class="loader"><img src="{{themes('images/loading.gif')}}" alt="#"/></div>
</div>
<!-- end loader -->
<!-- top -->
<!-- header -->
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="hedingh3 text_align_left">
                        <h3>countrys</h3>
                        <div class="map">
                            <img src="{{themes('images/map.png')}}" alt="#"/>
                        </div>
                    </div>
                </div>
